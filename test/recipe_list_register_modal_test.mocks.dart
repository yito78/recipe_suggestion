...
// in recipe_suggestion/test/recipe_list_register_modal_test.dart.
...
class MockFirebase extends _i1.Mock implements _i7.Firebase {
  ...
  @override
  _i5.Future<List<_i8.Recipe>> searchAllRecipesTypeSafe() =>
      (super.noSuchMethod(
        Invocation.method(
          #searchAllRecipesTypeSafe,
          [],
        ),
  ...
  @override
  _i5.Future<dynamic> deleteRecipes(
    dynamic name,
    dynamic category,
  ) =>
      (super.noSuchMethod(
